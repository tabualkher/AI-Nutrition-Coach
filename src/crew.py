...
class BaseNourishBotCrew:
    ...
    def ingredient_detection_task(self) -> Task:
        tasks_config = self.tasks_config['ingredient_detection_task']

        return Task(
            description=tasks_config['description'],
            agent=self.ingredient_detection_agent(),
            expected_output=tasks_config['expected_output']
        )
    ...
    def nutrient_analysis_task(self) -> Task:
        ...
        return Task(
            description=self.tasks_config['description'],
            agent=self.nutrient_analysis_agent(),
            expected_output=self.tasks_config['expected_output'],
